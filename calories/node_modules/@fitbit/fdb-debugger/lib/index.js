...
class RemoteHost extends events_1.EventEmitter {
    constructor(timeout) {
        ...
        this.handleMessage = (params) => {
            if (params.timestamp) {
                this.emit('consoleMessage', Object.assign({}, params, { timestamp: this.convertTimestamp(params.timestamp) }));
            }
            else {
        ...
        this.handleTrace = (params) => {
            if (params.timestamp) {
                this.emit('consoleTrace', Object.assign({}, params, { timestamp: this.convertTimestamp(params.timestamp) }));
            }
            else {
