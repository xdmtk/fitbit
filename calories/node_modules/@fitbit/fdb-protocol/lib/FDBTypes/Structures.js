...
exports.Semver = new t.Type('Semver', (value) => t.string.is(value) && semver.valid(value) !== null, (value, context) => t.string.validate(value, context).chain((str) => {
...
exports.UUID = t.refinement(t.string, s => isUUID(s), 'UUID');
