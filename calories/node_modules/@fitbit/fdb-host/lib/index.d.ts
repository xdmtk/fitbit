...
export declare class Host extends EventEmitter {
    ...
    handleAppInstallBegin: (params: {
        componentBundle: "companion" | "app";
    }) => {
        stream: string | number;
    };
    validateAppInstallStream(stream: FDBTypes.StreamToken): void;
    handleAppInstallFinalize: ({ stream }: {
        stream: string | number;
    }) => Promise<{
        app: {
            uuid: string;
        ...
        components: ("companion" | "app" | "settings")[];
    } & {
        installType?: "full" | "partial" | undefined;
    }>;
    handleAppInstallAbort: ({ stream }: {
        stream: string | number;
    }) => void;
    ...
    consoleMessage: (args: {
        ...
        emittedBy: ({
            ...
            component: "companion" | "app" | "settings";
        }) | {
            hostID?: string | undefined;
        };
        kind: "error" | "log" | "info" | "warn";
        message: any[];
    }) => boolean;
    consoleTrace: (args: {
        emittedBy: ({
