...
exports.DiagnosticCategory = diagnostics_1.DiagnosticCategory;
...
function readableIf(condition, plugin) {
...
function buildComponent({ projectConfig, component, polyfills = {}, onDiagnostic = diagnostics_1.logDiagnosticToConsole, }) {
...
function buildDeviceComponents({ projectConfig, buildId, onDiagnostic = diagnostics_1.logDiagnosticToConsole, }) {
    return multistream_1.default.obj([
        ...projectConfig.buildTargets.map((family) => lazyObjectReadable(() => {
            const { platform, displayName, polyfills, maxDeviceBundleSize, } = buildTargets_1.default[family];
            onDiagnostic({
            ...
            return new pumpify_1.default.obj(merge_stream_1.default(new pumpify_1.default.obj(buildComponent({
                projectConfig,
                onDiagnostic,
                polyfills,
                component: componentTargets_1.ComponentType.DEVICE,
            }), sourceMap.collector(componentTargets_1.ComponentType.DEVICE, family)), new pumpify_1.default.obj(vinyl_fs_1.default.src('./resources/**', { base: '.' }), buildDeviceResources(projectConfig, buildTargets_1.default[family], onDiagnostic)), readableIf(sdkVersion_1.default().major >= 4 ||
                (sdkVersion_1.default().major === 3 && sdkVersion_1.default().minor >= 1), new pumpify_1.default.obj(vinyl_fs_1.default.src(componentTargets_1.default.device.translationsGlob, {
                base: '.',
            }), compileTranslations_1.default(projectConfig.defaultLanguage)))), componentManifest_1.makeDeviceManifest({ projectConfig, buildId }), zip_1.default(bundleFilename), transformIf(maxDeviceBundleSize !== undefined, validateFileSizes_1.default({
                onDiagnostic,
